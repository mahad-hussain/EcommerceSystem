...
public class Product
{
	...
	private ArrayList<Product> readFile(String filename)
	{
		...
		//creates the product array list
       ...
       while (reader.hasNextLine()) 
       {
		...
		//creates a product object using the information
		 Product p = new Product(name, id, price, stock , Product.Category.COMPUTERS);

		 //ads the product objects to the array
		 prod.add(p);
